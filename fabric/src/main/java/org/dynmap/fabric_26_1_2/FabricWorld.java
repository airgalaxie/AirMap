...
public class FabricWorld extends DynmapWorld {
    ...
    /**
     * Return the reversible, filesystem-safe storage name for a canonical
     * Minecraft world ID. ASCII letters, digits, '.', '_' and '-' remain
     * readable; every other UTF-8 byte is percent-encoded.
     */
