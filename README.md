...
> **Current Baseline:** Minecraft `26.2`; later lines, including `27.2`, are intended to be selectable through the central catalog plus necessary mapping/API adaptations.<br>
...
> **Status:** Development snapshot. Consult the version catalog for the exact current targets.
