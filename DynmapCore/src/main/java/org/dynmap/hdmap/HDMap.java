...
//    private ConfigurationNode configuration;
    ...
    public void buildClientConfiguration(JsonObject worldObject, DynmapWorld world) {
        ...
        o.addProperty("type", "HDMapType");
        o.addProperty("name", name);
        o.addProperty("title", title);
        o.addProperty("icon", icon);
        o.addProperty("prefix", prefix);
        o.addProperty("background", bg_cfg);
        o.addProperty("backgroundday", bg_day_cfg);
        o.addProperty("backgroundnight", bg_night_cfg);
        o.addProperty("bigmap", true);
        o.addProperty("mapzoomout", world.getExtraZoomOutLevels() + mapzoomout);
        o.addProperty("mapzoomin", mapzoomin);
        o.addProperty("boostzoom", boostzoom);
        o.addProperty("tilescale", tilescale);
        o.addProperty("protected", false);
        o.addProperty("image-format", imgformat.getFileExt());
        if(append_to_world.length() > 0)
            o.addProperty("append_to_world", append_to_world);
        perspective.addClientConfiguration(o);
        shader.addClientConfiguration(o);
        lighting.addClientConfiguration(o);
        
        JsonArray maps = worldObject.getAsJsonArray("maps");
        if (maps == null) {
            maps = new JsonArray();
            worldObject.add("maps", maps);
        }
        maps.add(o);
